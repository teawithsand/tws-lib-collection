...
import {
	CopyEntryOperationArgs,
	CopyEntryOperationStage,
	CopyEntryOperationState,
...
type CopyStateAtom = ReturnType<typeof atom<CopyEntryOperationState>>
...
class CopyEntryOperationSession {
	public constructor(
		private readonly store: JotaiStore,
		private readonly args: CopyEntryOperationArgs,
	...
	public readonly start = (): OperationHandle<CopyEntryOperationState> => ({
	...
	private readonly createAtoms = (): CopyAtoms => {
		const stateAtom = atom<CopyEntryOperationState>({
	...
	private readonly copyHandle = async (
		...
		if (state.stage !== CopyEntryOperationStage.COPYING) return
...
export class CopyEntryOperationRunner
	implements OperationRunner<CopyEntryOperationState, CopyEntryOperationArgs>
{
	public constructor(
		private readonly store: JotaiStore,
	...
	public readonly runOperation = (
		args: CopyEntryOperationArgs,
	): OperationHandle<CopyEntryOperationState> => {
		return new CopyEntryOperationSession(
			this.store,
			args,
