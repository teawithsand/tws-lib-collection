/**
 * Operation runner which removes multiple handles and their children.
 */
import {
	atom,
	FsDirHandle,
...
class RemoveEntriesOperationSession {
	public constructor(
...
export class RemoveEntriesOperationRunner
	implements
		OperationRunner<RemoveEntriesOperationState, RemoveEntriesOperationArgs>
{
	...
	/**
	 * Starts removal of provided handles.
	 */
	public readonly runOperation = (
		args: RemoveEntriesOperationArgs,
	): OperationHandle<RemoveEntriesOperationState> => {
		return new RemoveEntriesOperationSession(this.store, args).start()
	}
}
