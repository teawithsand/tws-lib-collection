/**
 * Stories for DispositionAbookEntryList component.
 *
 * The component focuses on disposition management:
 * - Shows disposition dropdowns for each entry
 * - Tracks disposition modifications
...
const meta = {
	title: "Components/Abook/EntryList/DispositionAbookEntryList",
	component: DispositionAbookEntryList,
	parameters: {
		layout: "fullscreen",
		docs: {
			description: {
				component:
					"A list component focused on disposition management. Users can change file dispositions and save the changes.",
			},
		},
	},
	decorators: [
	...
	argTypes: {
		...
		onSaveChanges: {
			control: false,
			description: "Callback fired when user saves disposition changes",
		},
		showMetadata: {
			control: "boolean",
...
} satisfies Meta<typeof DispositionAbookEntryList>
