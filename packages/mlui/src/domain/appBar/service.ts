...
import {
	...
	type AppBarMoreAction,
	type AppBarNavigationConfig,
...
export class AppBarService {
	...
	private readonly _baseState: ReturnType<typeof atom<AppBarState>>
	private _sequenceCounter = 0

	public constructor(baseState: AppBarState) {
		this._baseState = atom<AppBarState>(baseState)
	}
